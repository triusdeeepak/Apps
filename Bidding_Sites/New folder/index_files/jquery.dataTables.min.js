...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Show _MENU_ entries",sZeroRecords:"No matching records found",sEmptyTable:"No data available in table",sInfo:T_("Showing <%= start_num %> to <%= end_num %> of <%= total_num %> entries", {start_num: "_START_", end_num: "_END_", total_num: "_TOTAL_"}),sInfoEmpty:T_("Showing 0 to 0 of 0 entries"),sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:T_("First"),sPrevious:T_("Previous"),sNext:T_("Next"),sLast:T_("Last")},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=
